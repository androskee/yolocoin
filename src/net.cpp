...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Yolocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"yolocoin.co", "yolocoin.co"},
    {"poolhasher.com", "poolhasher.com"},	
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Yolocoin is probably already running."), addrBind.ToString().c_str());
        else
